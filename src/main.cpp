...
#define relayPin1  GPIO_NUM_16
#define relayPin2  GPIO_NUM_17
...
<body>
  ...
  <div class="content">
    <div class="card">
      ...
      <p><button id="relay_1" class="button">Toggle</button></p>
    </div>
    <div class="card">
      <h2>Relay 2</h2>
      <p class="state">state: <span id="state_2">%STATE2%</span></p>
      <p><button id="relay_2" class="button">Toggle</button></p>
    </div>
  </div>
<script>
  ...
  function initButton() {
    document.getElementById('relay_1').addEventListener('click', toggle_1);
    document.getElementById('relay_2').addEventListener('click', toggle_2);
  }
  function toggle_1(){
...
void handleWebSocketMessage(void *arg, uint8_t *data, size_t len) {
  ...
  if (info->final && info->index == 0 && info->len == len && info->opcode == WS_TEXT) {
    ...
    if (strcmp((char*)data, "toggle1") == 0) {
      ...
      notifyClients(("STATE1_" + String(relayState1)));
    }
    if (strcmp((char*)data, "toggle2") == 0) {
      relayState2 = !relayState2;
      notifyClients(("STATE2_" + String(relayState2)));
    }
  }
}
